...
const styles = StyleSheet.create({ flex: { flex: 1 }, content: { padding: spacing.lg, paddingBottom: 60 }, topActions: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 14 }, actionText: { fontSize: 17, fontWeight: '700' }, card: { borderRadius: 17, padding: 14, borderWidth: StyleSheet.hairlineWidth, marginBottom: 13 }, titleInput: { fontSize: 19, fontWeight: '700', paddingVertical: 9, borderBottomWidth: StyleSheet.hairlineWidth }, notesInput: { minHeight: 72, fontSize: 16, paddingTop: 12, textAlignVertical: 'top' }, row: { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: 10 }, rowLabel: { fontSize: 16, fontWeight: '600', flex: 1 }, pickerWrap: { alignItems: 'flex-start' }, quickDates: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 8 }, label: { fontSize: 15, fontWeight: '800', marginBottom: 10 }, chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, chip: { borderRadius: 12, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 9 }, intervalRow: { marginTop: 14, paddingTop: 12, borderTopWidth: StyleSheet.hairlineWidth, flexDirection: 'row', alignItems: 'center', gap: 9 }, step: { width: 34, height: 34, borderRadius: 10, borderWidth: 1, alignItems: 'center', justifyContent: 'center' }, interval: { minWidth: 25, textAlign: 'center', fontWeight: '800', fontSize: 17 }, weekdays: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 12 }, weekday: { width: 35, height: 35, borderRadius: 18, borderWidth: 1, alignItems: 'center', justifyContent: 'center' }, tagInput: { borderWidth: StyleSheet.hairlineWidth, borderRadius: 11, padding: 11, fontSize: 16 }, hint: { fontSize: 12, marginTop: 6 }, deleteButton: { height: 50, borderRadius: 14, borderWidth: 1, alignItems: 'center', justifyContent: 'center' } });
