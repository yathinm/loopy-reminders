...
const styles = StyleSheet.create({
  container: { width: '100%', alignSelf: 'stretch', minHeight: 72, borderBottomWidth: StyleSheet.hairlineWidth, overflow: 'hidden' }, content: { width: '100%', minHeight: 72, flexDirection: 'row', paddingVertical: 13, paddingHorizontal: 14, gap: spacing.md, zIndex: 3 },
