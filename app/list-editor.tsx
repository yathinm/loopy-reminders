...
export default function ListEditorScreen() {
  ...
  return <Screen>
    ...
    <View style={[styles.preview, { backgroundColor: colors.softBrand }]}><View style={[styles.previewIcon, { backgroundColor: color }]}><Ionicons name={symbol} size={32} color={colors.onColor} /></View><Text style={[styles.previewText, { color: colors.text }]}>{name.trim() || 'New List'}</Text></View>
