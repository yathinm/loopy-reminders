  ...
  return (
    <Screen scroll={false}>
      <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={styles.content}>
        <View style={[styles.mascotBanner, { backgroundColor: colors.softBrand }]}>
          <View style={styles.mascotCopy}><Text style={[styles.mascotTitle, { color: colors.text }]}>Ready when you are</Text><Text style={[styles.mascotMessage, { color: colors.secondaryText }]}>Loopy is here to keep things moving.</Text></View>
          <LoopyMascot variant="driving" size={92} />
        </View>
...
const styles = StyleSheet.create({
  content: { padding: 16, paddingBottom: 110 }, mascotBanner: { height: 100, borderRadius: 22, paddingLeft: 18, paddingRight: 8, marginBottom: 14, flexDirection: 'row', alignItems: 'center', overflow: 'hidden' }, mascotCopy: { flex: 1 }, mascotTitle: { fontSize: 19, fontWeight: '800' }, mascotMessage: { fontSize: 14, lineHeight: 19, marginTop: 3 }, toolbar: { width: '100%', marginBottom: 16 }, searchButton: { width: '100%', height: 50, borderRadius: 25, borderWidth: StyleSheet.hairlineWidth, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 17, gap: 10 }, searchLabel: { fontSize: 16, fontWeight: '600' }, error: { padding: 12, borderRadius: 12, marginTop: 12 },
