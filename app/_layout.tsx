...
function AppNavigator() {
  ...
  return <><StatusBar style={scheme === 'dark' ? 'light' : 'dark'} /><Stack screenOptions={{ headerTintColor: colors.accent, headerStyle: { backgroundColor: colors.background, ...(desktopWeb ? { height: 68 } : {}) }, headerShadowVisible: false, contentStyle: { backgroundColor: colors.background }, headerBackButtonDisplayMode: 'minimal', headerBackVisible: Platform.OS !== 'web', headerLeft: desktopWeb ? () => <DesktopBackButton color={colors.accent} /> : undefined }}><Stack.Screen name="index" options={{ title: 'Loopy Reminders' }} /><Stack.Screen name="notes" options={{ title: 'Notes' }} /><Stack.Screen name="list/[id]" options={{ title: 'Reminders' }} /><Stack.Screen name="recently-deleted" options={{ title: 'Recently Deleted' }} /><Stack.Screen name="reminder/new" options={{ title: 'New Reminder', presentation: 'modal' }} /><Stack.Screen name="reminder/[id]" options={{ title: 'Edit Reminder', presentation: 'modal' }} /><Stack.Screen name="search" options={{ title: 'Search' }} /><Stack.Screen name="settings" options={{ title: 'Settings', headerLargeTitle: true }} /><Stack.Screen name="list-editor" options={{ title: 'List', presentation: 'modal' }} /></Stack></>;
}
